...
We actively support the following versions of `dev-log-core` with security updates:
...
`dev-log-core` includes several built-in security features:
...
We take the security of `dev-log-core` seriously. If you believe you have found a security vulnerability, please report it to us as described below.
...
2. **GitHub Security Advisory**: Use GitHub's [private vulnerability reporting](https://github.com/alphacointech1010/dev-log-core/security/advisories/new) feature
...
To help protect your application when using `dev-log-core`:

1. **Keep dependencies updated**: Regularly update `dev-log-core` to the latest version
...
We appreciate the security research community's efforts to help keep `dev-log-core` and its users safe. Thank you for your responsible disclosure.
